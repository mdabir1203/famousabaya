export const MAX_INVOICE_NUMBERS = 500;
export const MAX_INVOICE_DIGITS_PER = 20;
export const MAX_INVOICE_RAW_CHARS = 12000;
export const INVOICE_TOKEN_RE = /^\d{1,20}$/;

export function parseInvoiceNumberList(raw) {
  const str = String(raw ?? '');
  if (str.length > MAX_INVOICE_RAW_CHARS) {
    return {
      ok: false,
      error:
        `List is too long. Use at most ${MAX_INVOICE_RAW_CHARS} characters or split across sessions.`,
      nums: [],
    };
  }
  const parts = str
